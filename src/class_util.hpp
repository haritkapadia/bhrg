...
#define GetSetDecl(TYPE, A)                                                    \
    GetDecl(TYPE, A);                                                          \
    SetDecl(TYPE, A);

#define Get(CLASS, TYPE, A)                                                    \
    TYPE CLASS::A() { return PPCAT(_, A); }
#define Set(CLASS, TYPE, A)                                                    \
    void CLASS::A(TYPE A) { PPCAT(_, A) = A; }
#define GetSet(CLASS, TYPE, A)                                                 \
    Get(CLASS, TYPE, A);                                                       \
    Set(CLASS, TYPE, A);
